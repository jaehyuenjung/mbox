...
const EditModal = ({ open, onClose, props }) => {
    ...
    <div className="min-h-fit h-full px-6 w-full min-w-fit  flex flex-col items-center justify-center animate-zoomIn ">
      ...
      >
        <div className="flex justify-between">
          <button className="py-2 px-3 float-left text-lg" onClick={onClose}>
            취소
          </button>
          <div className="py-2 px-3 text-center text-lg">앨범 정보 수정</div>
          <button
